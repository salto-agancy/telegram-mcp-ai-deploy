...
| Public clean-history GitHub repo | PENDING | switch only after final clean-root audit and anonymous clone test |
| No secrets in history | PASS | local full-history scanner; Gitleaks 8.28.0; pre-push hook; GitHub secret-scan workflow |
...
| Clean environment test | PASS | fresh local clone, ignored state, static Compose, no Mac paths |
